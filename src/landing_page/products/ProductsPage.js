...
function ProductsPage() {
    return (
        <>
            ...
            <RightSection imageURL="media/images/console.png" productName="Console" productDescription="The central dashboard for your DPravah account. Gain insights into your trades and investments with in-depth reports and visualisations." learnMore=""/>
            ...
            <p className='text-center'>Want to know more about our technology stack? Check out the DPravah.tech blog</p>
            <Universe />
        </>
    );
}
